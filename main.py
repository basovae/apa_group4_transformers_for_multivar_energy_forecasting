...
def init_dl_program(
    ...
    try:
        import numpy
        numpy.set_num_threads(max_threads)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--heads', type=int, default=8, help='head in attention')
    parser.add_argument('--d_model', type=int, default=64, help='dimension of model')
    parser.add_argument('--N', type=int, default=5, help='number of learnable basis')
    ...
    record_dir = os.path.join('records', args.data_path.split('.')[0], 'features_' + args.features, 'seq_len' + str(args.seq_len) + ',' + 'pred_len' + str(args.pred_len))
