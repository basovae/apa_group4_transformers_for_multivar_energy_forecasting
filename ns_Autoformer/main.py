...
from ns_Autoformer.utils.metrics import metric
from ns_Autoformer.utils.tools import EarlyStopping, adjust_learning_rate, visual
from ns_Autoformer import ns_Autoformer
...
def parse_args():
    ...
    # basic config
    parser.add_argument('--is_training', type=bool, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='test', help='model id')
    parser.add_argument('--model', type=str, default='ns_Autoformer',
